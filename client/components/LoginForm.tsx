...
import { Eye, EyeOff, Lock, Mail, CheckCircle, XCircle, Loader2 } from "lucide-react";
  ...
  return (
    ...
    >
        ...
        <div className="relative">
          ...
          <input
            ...
            className={cn(
              ...
              emailValid === null && "border-white/20 focus:ring-folder-primary/50",
              emailValid === true && "border-neon-green focus:ring-neon-green/50",
              emailValid === false && "border-red-400 focus:ring-red-400/50"
            )}
          />
          <AnimatePresence>
            {email && (
      ...
      >
        ...
        <p className="text-sm text-white/80">Email: demo@example.com</p>
        <p className="text-sm text-white/80">Password: demo123</p>
      </motion.div>
    </motion.div>
  );
}

...
export const LazyTicketInventoryDashboard = lazy(() => import('./TicketInventoryDashboard'));
export const LazyBulkTicketPurchaseForm = lazy(() => import('./BulkTicketPurchaseForm'));
...
export const TicketInventoryDashboard = withLazyLoading(LazyTicketInventoryDashboard);
export const BulkTicketPurchaseForm = withLazyLoading(LazyBulkTicketPurchaseForm);
